...
description: Two-file output convention for every COMP9319 assignment solution
metadata:
  node_type: memory
  type: feedback
---

For every COMP9319 assignment, produce the solution in TWO files (do not delete the readable one):
